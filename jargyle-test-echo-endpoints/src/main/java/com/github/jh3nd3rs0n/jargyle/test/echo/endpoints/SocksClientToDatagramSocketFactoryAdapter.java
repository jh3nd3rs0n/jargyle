...
public final class SocksClientToDatagramSocketFactoryAdapter
        extends DatagramSocketFactory {

    private final SocksClient socksClient;

    public SocksClientToDatagramSocketFactoryAdapter(final SocksClient client) {
    ...
    public DatagramSocket newDatagramSocket(
        ...
        return this.socksClient.getSocksDatagramSocketFactory().newDatagramSocket(
                bindaddr);
    }
