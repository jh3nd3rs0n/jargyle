...
public class EchoEndpointsUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethodIT {
    ...
    public void testEchoDatagramClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod01() throws IOException {
        EchoDatagramClient echoDatagramClient = new EchoDatagramClient(
                new SocksDatagramSocketFactory(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
    ...
    public void testEchoClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod01() throws IOException {
        EchoClient echoClient = new EchoClient(
                new SocksSocketFactory(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
        String string = StringConstants.STRING_01;
    ...
    public void testEchoServerUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod01() throws IOException {
        EchoServer echServer = EchoServer.newInstance(
                new SocksServerSocketFactory(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()), 0);
        String string = StringConstants.STRING_01;
