...
public final class ResourceNameConstants {
	...
	public static final String CLIENT_KEY_STORE_PASSWORD_FILE =
			"jargyle/server/client.jks.password";

	public static final String COMBINED_CONFIGURATION_FILE =
			"jargyle/server/combined_configuration.xml";
	
	public static final String CONFIGURATION_FILE =
			"jargyle/server/configuration.xml";
