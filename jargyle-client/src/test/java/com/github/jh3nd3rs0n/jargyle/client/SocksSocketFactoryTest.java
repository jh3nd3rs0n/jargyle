...
public class SocksSocketFactoryTest {
    ...
    public void testNewInstance02() {
        ...
        try {
            ...
            Assert.assertNotNull(socksSocketFactory);
            SocksClient socksClient = socksSocketFactory.getSocksClient();
