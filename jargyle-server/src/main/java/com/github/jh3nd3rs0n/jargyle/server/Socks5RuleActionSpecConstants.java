...
public final class Socks5RuleActionSpecConstants {
	...
	public static final RuleActionSpec<PortRange> SOCKS5_ON_REQUEST_EXTERNAL_FACING_BIND_TCP_PORT_RANGE = RULE_ACTION_SPECS.addThenGet(new PortRangeRuleActionSpec(
	...
	public static final RuleActionSpec<PortRange> SOCKS5_ON_REQUEST_EXTERNAL_FACING_BIND_UDP_PORT_RANGE = RULE_ACTION_SPECS.addThenGet(new PortRangeRuleActionSpec(
	...
	public static final RuleActionSpec<SocketSetting<Object>> SOCKS5_ON_REQUEST_EXTERNAL_FACING_SOCKET_SETTING = RULE_ACTION_SPECS.addThenGet(new SocketSettingRuleActionSpec(
	...
	public static final RuleActionSpec<Host> SOCKS5_ON_REQUEST_INTERNAL_FACING_BIND_HOST = RULE_ACTION_SPECS.addThenGet(new HostRuleActionSpec(
	...
	public static final RuleActionSpec<SocketSetting<Object>> SOCKS5_ON_REQUEST_INTERNAL_FACING_SOCKET_SETTING = RULE_ACTION_SPECS.addThenGet(new SocketSettingRuleActionSpec(
	...
	public static final RuleActionSpec<PositiveInteger> SOCKS5_ON_REQUEST_RELAY_BUFFER_SIZE = RULE_ACTION_SPECS.addThenGet(new PositiveIntegerRuleActionSpec(
	...
	public static final RuleActionSpec<PositiveInteger> SOCKS5_ON_REQUEST_RELAY_IDLE_TIMEOUT = RULE_ACTION_SPECS.addThenGet(new PositiveIntegerRuleActionSpec(
	...
	public static final RuleActionSpec<PositiveInteger> SOCKS5_ON_REQUEST_RELAY_INBOUND_BANDWIDTH_LIMIT = RULE_ACTION_SPECS.addThenGet(new PositiveIntegerRuleActionSpec(
	...
	public static final RuleActionSpec<PositiveInteger> SOCKS5_ON_REQUEST_RELAY_OUTBOUND_BANDWIDTH_LIMIT = RULE_ACTION_SPECS.addThenGet(new PositiveIntegerRuleActionSpec(
