...
public final class TestResourceConstants {
	...
	public static final TestResource JARGYLE_SERVER_TEST_CONFIGREPO_IMPL_CONFIGURATION_FILE = new TestResource(
			"com/github/jh3nd3rs0n/jargyle/server/test/configrepo/impl/configuration.xml");
