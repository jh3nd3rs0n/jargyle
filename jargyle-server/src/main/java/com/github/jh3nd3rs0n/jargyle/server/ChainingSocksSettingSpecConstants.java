...
public final class ChainingSocksSettingSpecConstants {
    ...
    @NameValuePairValueSpecDoc(
            ...
            syntax = "chaining.socks5.gssapiauthmethod.protectionLevels=SOCKS_GSSAPIAUTHMETHOD_PROTECTION_LEVELS",
    ...
    @NameValuePairValueSpecDoc(
            ...
            syntax = "chaining.socks5.methods=SOCKS_METHODS",
            valueType = CommaSeparatedValues.class
    )
    ...
    @NameValuePairValueSpecDoc(
            ...
            name = "chaining.socks5.socks5HostResolver.resolveFromSocksServer",
            syntax = "chaining.socks5.socks5HostResolver.resolveFromSocksServer=true|false",
            valueType = Boolean.class
    )
