...
public class EchoObjectsUsingChainedSocks5ClientToSocksServersUsingSocks5UserpassMethodTest {
    ...
    @Test
    public void testDatagramEchoClientUsingChainedSocks5ClientToSocksServersUsingSocks5UserpassMethod05() throws IOException {
        DatagramEchoClient datagramEchoClient = new DatagramEchoClient(
                newChainedSocks5ClientToSocksServersUsingSocks5UserpassMethod().newSocksNetObjectFactory());
