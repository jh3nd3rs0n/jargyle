 ...
 * data received.
 */
public final class GssapiAuthMethodEncapsulation extends MethodEncapsulation {
    ...
    /**
     * Constructs a {@code GssapiAuthMethodEncapsulation} with the provided
     ...
     *                (can be {@code null})
     */
    public GssapiAuthMethodEncapsulation(
            final Socket sock,
