...
public class EchoObjectsUsingChainedSocks5ClientToSocksServersTest {
    ...
    @Test
    public void testDatagramEchoClientUsingChainedSocks5ClientToSocksServers05() throws IOException {
        DatagramEchoClient datagramEchoClient = new DatagramEchoClient(
                newChainedSocks5ClientToSocksServers().newSocksNetObjectFactory());
