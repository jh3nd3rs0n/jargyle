...
public class EchoObjectsUsingSocks5ClientToSocksServerIT {
	...
	private static com.github.jh3nd3rs0n.jargyle.test.netty.example.socksproxy.SocksServer nettySocksServer;
	...
	public static void setUpBeforeClass() throws IOException {
		...
		nettySocksServer = new com.github.jh3nd3rs0n.jargyle.test.netty.example.socksproxy.SocksServer();
	...
	public static void tearDownAfterClass() throws IOException {
		...
		if (nettySocksServer != null 
				&& !nettySocksServer.getState().equals(
						com.github.jh3nd3rs0n.jargyle.test.netty.example.socksproxy.SocksServer.State.STOPPED)) {
