...
public class EchoEndpointsUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethodIT {
    ...
    private static SocksClient newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod() {
    ...
    public static void tearDownAfterClass() throws IOException {
        ...
        if (socksServersUsingSocks5UserpassAuthMethod != null) {
            stop(socksServersUsingSocks5UserpassAuthMethod);
        }
        ThreadHelper.interruptibleSleepForThreeSeconds();
    }

    @Test
    public void testEchoDatagramClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod01() throws IOException {
        EchoDatagramClient echoDatagramClient = new EchoDatagramClient(
                new SocksClientToDatagramSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
    ...
    @Test
    public void testEchoDatagramClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod02() throws IOException {
        EchoDatagramClient echoDatagramClient = new EchoDatagramClient(
                new SocksClientToDatagramSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
    ...
    @Test
    public void testEchoDatagramClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod03() throws IOException {
        EchoDatagramClient echoDatagramClient = new EchoDatagramClient(
                new SocksClientToDatagramSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
    ...
    @Test
    public void testEchoDatagramClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod04() throws IOException {
        EchoDatagramClient echoDatagramClient = new EchoDatagramClient(
                new SocksClientToDatagramSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
    ...
    @Test
    public void testEchoDatagramClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod05() throws IOException {
        EchoDatagramClient echoDatagramClient = new EchoDatagramClient(
                new SocksClientToDatagramSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
    ...
    @Test
    public void testEchoClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod01() throws IOException {
        EchoClient echoClient = new EchoClient(
                new SocksClientToSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
        String string = StringConstants.STRING_01;
    ...
    @Test
    public void testEchoClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod02() throws IOException {
        EchoClient echoClient = new EchoClient(
                new SocksClientToSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
        String string = StringConstants.STRING_02;
        String returningString = echoClient.echo(string, echoServerPort);
    ...
    @Test
    public void testEchoClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod03() throws IOException {
        EchoClient echoClient = new EchoClient(
                new SocksClientToSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
        String string = StringConstants.STRING_03;
        String returningString = echoClient.echo(string, echoServerPort);
    ...
    @Test
    public void testEchoClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod04() throws IOException {
        EchoClient echoClient = new EchoClient(
                new SocksClientToSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
        String string = StringConstants.STRING_04;
        String returningString = echoClient.echo(string, echoServerPort);
    ...
    @Test
    public void testEchoClientUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod05() throws IOException {
        EchoClient echoClient = new EchoClient(
                new SocksClientToSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()));
        String string = StringConstants.STRING_05;
        String returningString = echoClient.echo(string, echoServerPort);
    ...
    @Test
    public void testEchoServerUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod01() throws IOException {
        EchoServer echServer = EchoServer.newInstance(
                new SocksClientToServerSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()), 0);
        String string = StringConstants.STRING_01;
    ...
    @Test
    public void testEchoServerUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod02() throws IOException {
        EchoServer echServer = EchoServer.newInstance(
                new SocksClientToServerSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()), 0);
        String string = StringConstants.STRING_02;
        String returningString = echServer.startThenEchoThenStop(
    ...
    @Test
    public void testEchoServerUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod03() throws IOException {
        EchoServer echServer = EchoServer.newInstance(
                new SocksClientToServerSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()), 0);
        String string = StringConstants.STRING_03;
        String returningString = echServer.startThenEchoThenStop(
    ...
    @Test
    public void testEchoServerUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod04() throws IOException {
        EchoServer echServer = EchoServer.newInstance(
                new SocksClientToServerSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()), 0);
        String string = StringConstants.STRING_04;
        String returningString = echServer.startThenEchoThenStop(
    ...
    @Test
    public void testEchoServerUsingChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod05() throws IOException {
        EchoServer echServer = EchoServer.newInstance(
                new SocksClientToServerSocketFactoryAdapter(newChainedSocks5ClientSetToSocksServersUsingSocks5UserpassAuthMethod()), 0);
        String string = StringConstants.STRING_04;
        String returningString = echServer.startThenEchoThenStop(
