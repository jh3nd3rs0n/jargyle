...
public class EchoDatagramServerBehindJargyleSocksServerUsingSocks5UserpassAuthMethodIT {
    ...
    @Test
    public void testEchoDatagramServerBehindJargyleSocksServerUsingSocks5UserpassAuthMethod() throws IOException {
        LoadTestRunnerResults results = new EchoDatagramServerLoadTestRunner(
                EchoDatagramServer.newInstance(0),
                newJargyleSocksServerUsingSocks5UserpassAuthMethod(),
                THREAD_COUNT,
