...
public class EchoDatagramServerBehindJargyleSocksServerUsingSslAndSocks5UserpassMethodIT {
    ...
    private static NetObjectFactory newSocks5NetObjectFactoryUsingSslAndSocks5UserpassMethod(
    ...
    private static AbstractSocksServer newJargyleSocksServerUsingSslAndSocks5UserpassMethod() {
    ...
    @Test
    public void testEchoDatagramServerBehindJargyleSocksServerUsingSslAndSocks5UserpassMethod() throws IOException {
        LoadTestRunnerResults results = new EchoDatagramServerLoadTestRunner(
                EchoDatagramServer.newInstance(0),
                newJargyleSocksServerUsingSslAndSocks5UserpassMethod(),
                THREAD_COUNT,
    ...
    private static final class EchoDatagramServerTestRunnerImpl extends EchoDatagramServerTestRunner {
        ...
        public void run() {
            EchoDatagramClient echoDatagramClient = new EchoDatagramClient(
                    newSocks5NetObjectFactoryUsingSslAndSocks5UserpassMethod(
