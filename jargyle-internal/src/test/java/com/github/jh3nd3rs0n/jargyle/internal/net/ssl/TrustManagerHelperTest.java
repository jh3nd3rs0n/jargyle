...
public class TrustManagerHelperTest {
    ...
    public void testGetTrustManagersInputStreamCharArrayString05() throws IOException {
        Assert.assertNotNull(TrustManagerHelper.getTrustManagers(
                TestKeyStoreResourceConstants.JARGYLE_TEST_HELP_SECURITY_KEY_STORE_FILE_5.getInputStream(),
                TestKeyStoreResourceConstants.JARGYLE_TEST_HELP_SECURITY_KEY_STORE_PASSWORD_FILE_5.getContentAsString().toCharArray(),
                null));
    }
    ...
    public void testGetTrustManagersInputStreamCharArrayString06() throws IOException {
        Assert.assertNotNull(TrustManagerHelper.getTrustManagers(
                TestKeyStoreResourceConstants.JARGYLE_TEST_HELP_SECURITY_KEY_STORE_FILE_6.getInputStream(),
                TestKeyStoreResourceConstants.JARGYLE_TEST_HELP_SECURITY_KEY_STORE_PASSWORD_FILE_6.getContentAsString().toCharArray(),
                null));
    }
