...
public class EchoDatagramServerBehindJargyleSocksServerUsingSslAndSocks5UserpassAuthMethodIT {
    ...
    @Test
    public void testEchoDatagramServerBehindJargyleSocksServerUsingSslAndSocks5UserpassAuthMethod() throws IOException {
        LoadTestRunnerResults results = new EchoDatagramServerLoadTestRunner(
                EchoDatagramServer.newInstance(0),
                newJargyleSocksServerUsingSslAndSocks5UserpassAuthMethod(),
                THREAD_COUNT,
