...
public class EchoEndpointsUsingSocks5NetObjectFactorySetToChainedSocksServersUsingSslIT {
    ...
    public static void tearDownAfterClass() throws IOException {
        ...
        if (chainedSocksServersUsingSsl != null) {
            stop(chainedSocksServersUsingSsl);
        }
    ...
    public void testEchoDatagramClientUsingSocks5NetObjectFactorySetToChainedSocksServersUsingSsl01() throws IOException {
        EchoDatagramClient echoDatagramClient = new EchoDatagramClient(
                new NetObjectFactoryToDatagramSocketFactoryAdapter(newSocks5NetObjectFactorySetToChainedSocksServersUsingSsl()));
    ...
    public void testEchoClientUsingSocks5NetObjectFactorySetToChainedSocksServersUsingSsl01() throws IOException {
        EchoClient echoClient = new EchoClient(
                new NetObjectFactoryToSocketFactoryAdapter(newSocks5NetObjectFactorySetToChainedSocksServersUsingSsl()));
        String string = StringConstants.STRING_01;
    ...
    public void testEchoServerUsingSocks5NetObjectFactorySetToChainedSocksServersUsingSsl01() throws IOException {
        EchoServer echServer = EchoServer.newInstance(
                new NetObjectFactoryToServerSocketFactoryAdapter(newSocks5NetObjectFactorySetToChainedSocksServersUsingSsl()), 0);
        String string = StringConstants.STRING_01;
