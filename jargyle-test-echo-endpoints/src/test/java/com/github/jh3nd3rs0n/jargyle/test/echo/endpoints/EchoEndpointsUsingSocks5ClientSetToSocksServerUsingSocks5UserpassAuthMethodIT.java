...
public class EchoEndpointsUsingSocks5ClientSetToSocksServerUsingSocks5UserpassAuthMethodIT {
	...
	private static SocksClient newSocks5ClientUsingSocks5UserpassAuthMethodImplicitly(
			final String username,
			final char[] password) {
		String usrname;
        try {
