 ...
 */
public final class Socks5UserpassAuthMethodEncryptedPasswordPropertySpec
        extends PropertySpec<EncryptedPassword> {

    /**
     * Constructs a
     * {@code Socks5UserpassAuthMethodEncryptedPasswordPropertySpec} with the
     * provided name and the provided default value. An
     ...
     */
    public Socks5UserpassAuthMethodEncryptedPasswordPropertySpec(
