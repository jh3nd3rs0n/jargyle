...
enum ServerSideAuthenticator {
	...
	private static final Logger LOGGER = Logger.getLogger(
			ServerSideAuthenticator.class.getName());
	
	public static ServerSideAuthenticator valueOf(final Method meth) {
		for (ServerSideAuthenticator value : ServerSideAuthenticator.values()) {
	...
	private ServerSideAuthenticator(final Method methValue) {
