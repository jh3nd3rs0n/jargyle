...
import com.github.jh3nd3rs0n.jargyle.internal.net.InetAddressComparator;
...
public final class Ipv4AddressRange extends AddressRange {
	...
	public static boolean isIpv4AddressRange(final String s) {
		return AddressRegexConstants.isIpv4Address(s)
	...
	public boolean contains(final String address) {
		if (!AddressRegexConstants.isIpv4Address(address)) {
			return false;
		}
