...
public class Socks5UserpassMethodUsernamePropertySpecTest {
    ...
    public void testParseString01() {
        Assert.assertEquals(
                TEST_USERNAME_01,
                new Socks5UserpassMethodUsernamePropertySpec(
                        "socks5UserpassMethodUsernameProperty",
                        null)
    ...
    @Test
    public void testSocks5UserpassMethodUsernamePropertySpecStringString01() {
        Assert.assertEquals(
                TEST_USERNAME_01,
                new Socks5UserpassMethodUsernamePropertySpec(
                        "socks5UserpassMethodUsernameProperty",
    ...
    @Test
    public void testSocks5UserpassMethodUsernamePropertySpecStringString02() {
        Assert.assertEquals(
                TEST_USERNAME_02,
                new Socks5UserpassMethodUsernamePropertySpec(
                        "socks5UserpassMethodUsernameProperty",
    ...
    @Test
    public void testSocks5UserpassMethodUsernamePropertySpecStringString03() {
        Assert.assertEquals(
                TEST_USERNAME_03,
                new Socks5UserpassMethodUsernamePropertySpec(
                        "socks5UserpassMethodUsernameProperty",
    ...
    public void testSocks5UserpassMethodUsernamePropertySpecStringStringForIllegalArgumentException01() {
        new Socks5UserpassMethodUsernamePropertySpec(
                "socks5UserpassMethodUsernameProperty",
                TEST_USERNAME_04);
    }
