...
public class ConfiguredDtlsDatagramSocketFactoryIT {
    ...
    public void testGetDatagramSocketDatagramSocket01() throws IOException {
        ...
        ConfiguredDtlsDatagramSocketFactory dtlsDatagramSocketFactory =
                ConfiguredDtlsDatagramSocketFactory.newInstance(properties);
