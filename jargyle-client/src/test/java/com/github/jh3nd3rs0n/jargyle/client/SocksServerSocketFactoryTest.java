...
public class SocksServerSocketFactoryTest {

    @Test
    public void testNewInstance01() {
        System.setProperty("socksClient.socksServerUri", "socks5://127.0.0.1");
        try {
            Assert.assertNotNull(SocksServerSocketFactory.newInstance());
        } finally {
    ...
    public void testNewInstance02() {
        ...
        try {
            ...
            Assert.assertNotNull(socksServerSocketFactory);
            SocksClient socksClient = socksServerSocketFactory.getSocksClient();
