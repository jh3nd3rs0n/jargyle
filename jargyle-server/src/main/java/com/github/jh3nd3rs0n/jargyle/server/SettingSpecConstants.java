...
final class SettingSpecConstants {
	...
	static {
		...
		values.addAll(ChainingSocksSettingSpecConstants.values());
        ...
        values.addAll(SocksSettingSpecConstants.values());
		...
		valuesMap.putAll(ChainingSocksSettingSpecConstants.valuesMap());
        ...
        valuesMap.putAll(SocksSettingSpecConstants.valuesMap());
