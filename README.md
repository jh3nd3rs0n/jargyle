...
```bash
    ...
    JARGYLE_OPTS="-Djavax.security.auth.useSubjectCredsOnly=false -Djava.security.auth.login.config=login.conf -Djava.security.krb5.conf=krb5.conf"
...
```bash
    ...
    JARGYLE_OPTS="-Djava.util.logging.config.file=logging.properties"
    ./bin/jargyle
