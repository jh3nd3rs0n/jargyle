...
final class SslSocketFactoryImpl extends SslSocketFactory {
    ...
    /**
     * Constructs a {@code SslSocketFactoryImpl} with the provided
     * {@code Properties}.
     *
     ...
     * used to configure this {@code SslSocketFactoryImpl} or {@code null}
     ...
     * configure this {@code SslSocketFactoryImpl}.
     *
