...
public class Socks5UserpassAuthMethodEncryptedPasswordPropertySpecTest {
    ...
    public void testParseString01() {
        Assert.assertArrayEquals(
                ...
                new Socks5UserpassAuthMethodEncryptedPasswordPropertySpec(
                        "socks5UserpassAuthMethodEncryptedPasswordProperty", 
                        null)
    ...
    @Test
    public void testSocks5UserpassAuthMethodEncryptedPasswordPropertySpecStringEncryptedPassword01() {
        Assert.assertArrayEquals(
                TEST_PASSWORD_01.toCharArray(),
                new Socks5UserpassAuthMethodEncryptedPasswordPropertySpec(
                        "socks5UserpassAuthMethodEncryptedPasswordProperty",
    ...
    @Test
    public void testSocks5UserpassAuthMethodEncryptedPasswordPropertySpecStringEncryptedPassword02() {
        Assert.assertArrayEquals(
                TEST_PASSWORD_02.toCharArray(),
                new Socks5UserpassAuthMethodEncryptedPasswordPropertySpec(
                        "socks5UserpassAuthMethodEncryptedPasswordProperty",
    ...
    @Test
    public void testSocks5UserpassAuthMethodEncryptedPasswordPropertySpecStringEncryptedPassword03() {
        Assert.assertArrayEquals(
                TEST_PASSWORD_03.toCharArray(),
                new Socks5UserpassAuthMethodEncryptedPasswordPropertySpec(
                        "socks5UserpassAuthMethodEncryptedPasswordProperty",
    ...
    public void testSocks5UserpassAuthMethodEncryptedPasswordPropertySpecStringEncryptedPasswordForIllegalArgumentException01() {
        new Socks5UserpassAuthMethodEncryptedPasswordPropertySpec(
                "socks5UserpassAuthMethodEncryptedPasswordProperty",
                EncryptedPassword.newInstance(
                        TEST_PASSWORD_04.toCharArray()));
