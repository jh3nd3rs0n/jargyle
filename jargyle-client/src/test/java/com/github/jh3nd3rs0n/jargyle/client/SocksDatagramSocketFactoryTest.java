...
public class SocksDatagramSocketFactoryTest {

    @Test
    public void testNewInstance01() {
        System.setProperty("socksClient.socksServerUri", "socks5://127.0.0.1");
        try {
            Assert.assertNotNull(SocksDatagramSocketFactory.newInstance());
        } finally {
    ...
    public void testNewInstance02() {
        ...
        try {
            ...
            Assert.assertNotNull(socksDatagramSocketFactory);
            SocksClient socksClient = socksDatagramSocketFactory.getSocksClient();
